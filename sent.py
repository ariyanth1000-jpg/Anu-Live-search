...
const RULES = {
    ...
    "-1002567258773": { start: 5, end: 4 },
    "-1002652123574": { start: 4, end: 4 },
    "-1003861246919": { start: 3, end: 4 },
    "-1003435291410": { start: 3, end: 4 },
    "-1003775658194": { start: 4, end: 4 },
    "-1002898987582": { start: 5, end: 4 },
    "-1003463811076": { start: 3, end: 4 },
    "-1003357916577": { start: 5, end: 4 }
